...
Эта роль добавлет пользователей и группы в систему
...
users:
  ...
  - name: notuser
    ...
    remove: true
  - name: keyuser
    # This user will have ssh-keys generated and added private_key.
    manage_ssh_key: true
    copy_private_key: true
  - name: keyuser
    # This user will have ssh-keys generated and added public_key
    manage_ssh_key: true
